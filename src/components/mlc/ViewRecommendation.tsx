...
function MLCViewRecommendation() {
  ...
  const fetchRecommendations = async () => {
    try {
      ...
      const response = await axios.get(`${baseURL}/api/mlc/recommendations`, {
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
        },
            ...
            <Table>
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead>MLC Letter</TableHead>
                  ...
                  <TableRow key={rec.id}>
                    ...
                    <TableCell>
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm">{rec.mlcLetter}</span>
              ...
              <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>MLC Recommendation Letter</FormLabel>
                        <FormControl>
                  ...
                  <div className="bg-muted/50 p-4 rounded-lg">
                    <h4 className="font-medium mb-2">MLC Details</h4>
